...
function Navbar() {
  ...
  return (
    <nav>
      <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRjHz8qJ8E0CVIqKTBSFtya849N5CskswtKToEK3WP4WA&s" onClick={navHome} alt="img" className='brand-logo'/>
